...
.controller('CheckoutCtrl', ['$scope', 'Auth', '$state', 'Order', 'ngCart','toaster','Voucher','Address','Payment','$uibModal', 'stateService','Cart',function($scope, Auth, $state, Order, ngCart, toaster,Voucher,Address,Payment, $uibModal, stateService, Cart) {
